...
Il rumore da seed non e' lo stesso nei due modelli: 0,04 punti sul denso, 0,37
sullo sparso, dove il backward di `grid_sample` non e' deterministico su CUDA.
Diverse delle differenze che il paper discute sono di quell'ordine, riportate su
un solo seed. Salta i seed gia' completati, quindi si puo' interrompere.
"""
